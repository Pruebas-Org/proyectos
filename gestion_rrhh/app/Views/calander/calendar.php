...
<html lang="es">
  ...
  <body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <!-- Content Column -->
                        <div class="col-xl-12 col-xl-15">

                           <div id='calendar-container shadow mb-4'>
                                  <div id='calendar'></div>
                                </div> 
                        </div>
    ...
    var events = JSON.parse(localStorage.getItem('festivos'));
    console.log(events);
    //recorrer events y guardarlos en formato json como title:, start
    var eventsArray = [];
  ...
  function festivos() {
    ...
    const url = `https://api.argentinadatos.com/v1/feriados/${ano}`; // Reemplaza con la URL real de tu API
    ...
    fetch(url)
        ...
        .then(data => {
          //guardar data en local storage
            localStorage.setItem('festivos', JSON.stringify(data));
...
// Función para mostrar los festivos en el DOM
function mostrarFestivos(festivos) {
      festivos.forEach(festivo => {
        console.log(festivo.fecha);
    })
}
// Llamada a la función festivos
    festivos();
